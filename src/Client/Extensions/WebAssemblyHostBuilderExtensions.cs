...
using GLifeInc.Client.Infrastructure.Authentication;
using GLifeInc.Client.Infrastructure.Managers;
using GLifeInc.Client.Infrastructure.Managers.Preferences;
...
using GLifeInc.Client.Infrastructure.Managers.ExtendedAttribute;
using GLifeInc.Domain.Entities.ExtendedAttributes;
using GLifeInc.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace GLifeInc.Client.Extensions
{
