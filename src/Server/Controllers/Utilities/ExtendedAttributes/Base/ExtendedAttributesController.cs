...
using GLifeInc.Application.Features.ExtendedAttributes.Commands.Delete;
...
using GLifeInc.Application.Features.ExtendedAttributes.Queries.GetById;
using GLifeInc.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace GLifeInc.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
